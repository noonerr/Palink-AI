...
class LoginDialog(QDialog):
    ...
    def init_ui(self):
        ...
        username_label.setStyleSheet(f"font-size: 12px; color: {Theme.TEXT_MUTED}; font-weight: 500; letter-spacing: 1px;")
        ...
        password_label.setStyleSheet(f"font-size: 12px; color: {Theme.TEXT_MUTED}; font-weight: 500; letter-spacing: 1px;")
