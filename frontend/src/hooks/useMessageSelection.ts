...
interface UseMessageSelectionOptions {
  ...
  handleDeleteMessage: (messageId: string | number, messageIndex: number) => Promise<void>;
  handleEditMessage: (messageId: string | number, messageIndex: number, newContent: string) => Promise<void>;
}
