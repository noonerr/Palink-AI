    ...
    for chunk in text_chunks:
        ...
        if null_pos != -1:
            try:
                ...
                print(f"Found chunk: type={chunk['type']}, keyword={keyword}")
...
if chara_card:
    print("\n" + "="*80)
    print("SUCCESS! Character card data extracted:")
    print("="*80)
    ...
    print("Failed to extract character card data")
