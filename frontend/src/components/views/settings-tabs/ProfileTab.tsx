...
import { ChevronDown, Key, LogOut, Save, Shield, UploadCloud, User as UserIcon } from 'lucide-react';
...
export function ProfileTab({
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-28 max-w-lg mx-auto">
        ...
        <div className="flex flex-col items-center text-center pt-4 pb-2">
          ...
          <h3 className="mt-5 text-xl font-semibold tracking-tight hidden md:block">{t.settings_profile}</h3>
